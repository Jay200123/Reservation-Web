            ...
            <div className="lg:w-[70rem] lg:h-[55rem] flex rounded-lg bg-white shadow-lg">
                ...
                <div className="lg:w-1/2 flex flex-col justify-center">
                    <form className=" lg:px-3.5 lg:py-3.5">
                        <h3 className="lg:text-4xl md:text-lg font-medium">Create Account</h3>
                        ...
                        <div className="flex flex-col p-2.5">
                            ...
                            <div className="relative">
                                ...
                                <input type="text" id="fullname" name="fullname" className="p-1.5 border border-gray-400 w-full rounded-md pr-3 pl-10" placeholder="John Doe" />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col p-2.5">
                            ...
                            <div className="relative">
                                ...
                                <input type="text" id="email" name="email" className="p-1.5 border border-gray-400 w-full rounded-md pr-3 pl-10" placeholder="john.doe@gmail.com" />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col p-2.5">
                            ...
                            <div className="relative">
                                ...
                                <input type="text" id="contact_number" name="contact_number" className="p-1.5 border border-gray-400 w-full rounded-md pr-3 pl-10" placeholder="+63 9123456789" />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col p-2.5">
                            ...
                            <div className="relative">
                                ...
                                <input type="text" id="address" name="address" className="p-1.5 border border-gray-400 w-full rounded-md pr-3 pl-10" placeholder="Block 115 Lot 8 Juan Street, etc." />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col p-2.5">
                            ...
                            <div className="relative">
                                ...
                                <input type="text" id="city" name="city" className="p-1.5 border border-gray-400 w-full rounded-md pr-3 pl-10" placeholder="Taguig City..." />
                            </div>
                        </div>
                        ...
                        <p className="text-base text-center">Already have an account?<span className="text-[#d4af37] underline">Sign In</span></p>
                    </form>
                </div>
